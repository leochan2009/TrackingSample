...
namespace pcl
{
  namespace tracking
  {
    /** \brief @b ApproxNearestPairPointCloudCoherenceLocal computes coherence between two pointclouds using the
         approximate nearest point pairs.
      * \author Ryohei Ueda
      * \ingroup tracking
      */
    template <typename PointInT>
    class ApproxNearestPairPointCloudCoherenceLocal: public NearestPairPointCloudCoherence<PointInT>
    {
    public:
      ...
      ApproxNearestPairPointCloudCoherenceLocal () :
        NearestPairPointCloudCoherence<PointInT> (), search_ ()
      {
        coherence_name_ = "ApproxNearestPairPointCloudCoherenceLocal";
      }
...
#include "approx_nearest_pair_point_cloud_coherence_local.hpp"
#endif
